...
- [TheoBourdel/fyc-google-drive](https://github.com/TheoBourdel/fyc-google-drive) - Ce projet vise à créer une application de stockage et de partage de fichiers, inspirée par les fonctionnalités de Google Drive. Il offre une interface conviviale permettant aux utilisateurs de télécharger, stocker, organiser et partager leurs fichiers en toute simplicité. (2 days ago)
- [Pietrucci-Blacher/Challenge-Semestriel-2](https://github.com/Pietrucci-Blacher/Challenge-Semestriel-2) -  (3 days ago)
- [Pietrucci-Blacher/CC-clean-code1](https://github.com/Pietrucci-Blacher/CC-clean-code1) -  (3 days ago)
