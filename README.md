...
- [prettier/prettier](https://github.com/prettier/prettier) ([3.5.0](https://github.com/prettier/prettier/releases/tag/3.5.0), 2 days ago) - Prettier is an opinionated code formatter.
- [lucide-icons/lucide](https://github.com/lucide-icons/lucide) ([0.475.0](https://github.com/lucide-icons/lucide/releases/tag/0.475.0), 4 days ago) - Beautiful &amp; consistent icon toolkit made by the community. Open-source project and a fork of Feather Icons.
- [wxt-dev/wxt](https://github.com/wxt-dev/wxt) ([module-svelte-v2.0.3](https://github.com/wxt-dev/wxt/releases/tag/module-svelte-v2.0.3), 2 weeks ago) - ⚡ Next-gen Web Extension Framework
