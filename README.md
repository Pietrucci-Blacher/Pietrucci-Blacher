...
- [Pietrucci-Blacher/Boilerplate-Dev-ViteJS](https://github.com/Pietrucci-Blacher/Boilerplate-Dev-ViteJS) - BoilerPlate for JS dev with SCSS  (today)
...
- [wxt-dev/wxt](https://github.com/wxt-dev/wxt) ([i18n-v0.2.0](https://github.com/wxt-dev/wxt/releases/tag/i18n-v0.2.0), 2 days ago) - ⚡ Next-gen Web Extension Framework
