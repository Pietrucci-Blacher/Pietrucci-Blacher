...
- [prettier/prettier](https://github.com/prettier/prettier) ([3.5.0](https://github.com/prettier/prettier/releases/tag/3.5.0), 1 day ago) - Prettier is an opinionated code formatter.
- [lucide-icons/lucide](https://github.com/lucide-icons/lucide) ([0.475.0](https://github.com/lucide-icons/lucide/releases/tag/0.475.0), 3 days ago) - Beautiful &amp; consistent icon toolkit made by the community. Open-source project and a fork of Feather Icons.
