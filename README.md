...
- [wxt-dev/wxt](https://github.com/wxt-dev/wxt) ([wxt-v0.19.18](https://github.com/wxt-dev/wxt/releases/tag/wxt-v0.19.18), 1 day ago) - ⚡ Next-gen Web Extension Framework
- [lucide-icons/lucide](https://github.com/lucide-icons/lucide) ([0.464.0](https://github.com/lucide-icons/lucide/releases/tag/0.464.0), 1 day ago) - Beautiful &amp; consistent icon toolkit made by the community. Open-source project and a fork of Feather Icons.
- [JanDeDobbeleer/oh-my-posh](https://github.com/JanDeDobbeleer/oh-my-posh) ([v24.11.4](https://github.com/JanDeDobbeleer/oh-my-posh/releases/tag/v24.11.4), 3 days ago) - The most customisable and low-latency cross platform/shell prompt renderer
