...
- [JanDeDobbeleer/oh-my-posh](https://github.com/JanDeDobbeleer/oh-my-posh) ([v24.17.1](https://github.com/JanDeDobbeleer/oh-my-posh/releases/tag/v24.17.1), 1 day ago) - The most customisable and low-latency cross platform/shell prompt renderer
- [lucide-icons/lucide](https://github.com/lucide-icons/lucide) ([0.469.0](https://github.com/lucide-icons/lucide/releases/tag/0.469.0), 3 days ago) - Beautiful &amp; consistent icon toolkit made by the community. Open-source project and a fork of Feather Icons.
- [wxt-dev/wxt](https://github.com/wxt-dev/wxt) ([module-react-v1.1.3](https://github.com/wxt-dev/wxt/releases/tag/module-react-v1.1.3), 6 days ago) - ⚡ Next-gen Web Extension Framework
