...
- [JanDeDobbeleer/oh-my-posh](https://github.com/JanDeDobbeleer/oh-my-posh) ([v25.3.0](https://github.com/JanDeDobbeleer/oh-my-posh/releases/tag/v25.3.0), 1 day ago) - The most customisable and low-latency cross platform/shell prompt renderer
- [wxt-dev/wxt](https://github.com/wxt-dev/wxt) ([unocss-v1.0.1](https://github.com/wxt-dev/wxt/releases/tag/unocss-v1.0.1), 2 days ago) - ⚡ Next-gen Web Extension Framework
- [lucide-icons/lucide](https://github.com/lucide-icons/lucide) ([0.479.0](https://github.com/lucide-icons/lucide/releases/tag/0.479.0), 4 days ago) - Beautiful &amp; consistent icon toolkit made by the community. Open-source project and a fork of Feather Icons.
