...
- [Pietrucci-Blacher/Boilerplate-Dev-ViteJS](https://github.com/Pietrucci-Blacher/Boilerplate-Dev-ViteJS) - Boilerplate for dev in Vanilla JS  (4 days ago)
...
- [wxt-dev/wxt](https://github.com/wxt-dev/wxt) ([unocss-v1.0.1](https://github.com/wxt-dev/wxt/releases/tag/unocss-v1.0.1), 1 day ago) - ⚡ Next-gen Web Extension Framework
- [lucide-icons/lucide](https://github.com/lucide-icons/lucide) ([0.479.0](https://github.com/lucide-icons/lucide/releases/tag/0.479.0), 3 days ago) - Beautiful &amp; consistent icon toolkit made by the community. Open-source project and a fork of Feather Icons.
- [JanDeDobbeleer/oh-my-posh](https://github.com/JanDeDobbeleer/oh-my-posh) ([v25.2.1](https://github.com/JanDeDobbeleer/oh-my-posh/releases/tag/v25.2.1), 3 days ago) - The most customisable and low-latency cross platform/shell prompt renderer
- [prettier/prettier](https://github.com/prettier/prettier) ([3.5.3](https://github.com/prettier/prettier/releases/tag/3.5.3), 1 week ago) - Prettier is an opinionated code formatter.
