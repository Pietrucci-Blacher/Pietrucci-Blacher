...
- [lucide-icons/lucide](https://github.com/lucide-icons/lucide) ([0.518.0](https://github.com/lucide-icons/lucide/releases/tag/0.518.0), 1 day ago) - Beautiful &amp; consistent icon toolkit made by the community. Open-source project and a fork of Feather Icons.
- [JanDeDobbeleer/oh-my-posh](https://github.com/JanDeDobbeleer/oh-my-posh) ([v26.9.0](https://github.com/JanDeDobbeleer/oh-my-posh/releases/tag/v26.9.0), 3 days ago) - The most customisable and low-latency cross platform/shell prompt renderer
