...
- [wxt-dev/wxt](https://github.com/wxt-dev/wxt) ([wxt-v0.19.29](https://github.com/wxt-dev/wxt/releases/tag/wxt-v0.19.29), 1 day ago) - ⚡ Next-gen Web Extension Framework
- [JanDeDobbeleer/oh-my-posh](https://github.com/JanDeDobbeleer/oh-my-posh) ([v25.2.0](https://github.com/JanDeDobbeleer/oh-my-posh/releases/tag/v25.2.0), 1 day ago) - The most customisable and low-latency cross platform/shell prompt renderer
- [prettier/prettier](https://github.com/prettier/prettier) ([3.5.3](https://github.com/prettier/prettier/releases/tag/3.5.3), 4 days ago) - Prettier is an opinionated code formatter.
- [lucide-icons/lucide](https://github.com/lucide-icons/lucide) ([0.477.0](https://github.com/lucide-icons/lucide/releases/tag/0.477.0), 1 week ago) - Beautiful &amp; consistent icon toolkit made by the community. Open-source project and a fork of Feather Icons.
