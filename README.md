...
- [prettier/prettier](https://github.com/prettier/prettier) ([3.5.1](https://github.com/prettier/prettier/releases/tag/3.5.1), 5 days ago) - Prettier is an opinionated code formatter.
- [wxt-dev/wxt](https://github.com/wxt-dev/wxt) ([wxt-v0.19.27](https://github.com/wxt-dev/wxt/releases/tag/wxt-v0.19.27), 6 days ago) - ⚡ Next-gen Web Extension Framework
